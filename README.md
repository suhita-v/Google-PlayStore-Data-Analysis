...
<b>Google Colab - </b>Includes all the code and their outputs executed in the python environment. <br> https://github.com/suhita-v/Google-PlayStore-Data-Analysis/blob/main/Google_Playstore_DataAnalysis.ipynb
  
<b>MySQL - </b>Includes all the queries that answer the problem statements based on the dataset. <br> https://github.com/suhita-v/Google-PlayStore-Data-Analysis/blob/main/GooglePlaystore.sql
